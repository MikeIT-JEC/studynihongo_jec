class ArticlesController < ApplicationController 
  ...
  def create
    ...
    respond_to do |format|
      if @article.save
        ...
        format.json { render :show, status: :created, location: admin_articles_path }
      else
  ...
  def update
    respond_to do |format|
      if @article.update(article_params)
        ...
        format.json { render :show, status: :ok, location: admin_articles_path }
      else
  ...
  private
    ...
    def article_params
      params.require(:article).permit(:title, :body, :admin_id, :image)
    end
end
